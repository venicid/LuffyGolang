...
// 	protoc        v3.19.1
// source: client_stream_rpc.proto
...
func (x *SimpleRequest) Reset() {
	*x = SimpleRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_client_stream_rpc_proto_msgTypes[0]
...
func (*SimpleRequest) Descriptor() ([]byte, []int) {
	return file_client_stream_rpc_proto_rawDescGZIP(), []int{0}
}
...
func (x *SimpleResponse) Reset() {
	*x = SimpleResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_client_stream_rpc_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SimpleResponse) Descriptor() ([]byte, []int) {
	return file_client_stream_rpc_proto_rawDescGZIP(), []int{1}
}
...
func (x *StreamRequest) Reset() {
	*x = StreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_client_stream_rpc_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamRequest) Descriptor() ([]byte, []int) {
	return file_client_stream_rpc_proto_rawDescGZIP(), []int{2}
}

func (x *StreamRequest) GetStreamValue() string {
	if x != nil {
...
var File_client_stream_rpc_proto protoreflect.FileDescriptor

var file_client_stream_rpc_proto_rawDesc = []byte{
	0x0a, 0x17, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f,
	...
	,
...
var (
	file_client_stream_rpc_proto_rawDescOnce sync.Once
	file_client_stream_rpc_proto_rawDescData = file_client_stream_rpc_proto_rawDesc
)

func file_client_stream_rpc_proto_rawDescGZIP() []byte {
	file_client_stream_rpc_proto_rawDescOnce.Do(func() {
		file_client_stream_rpc_proto_rawDescData = protoimpl.X.CompressGZIP(file_client_stream_rpc_proto_rawDescData)
	})
	return file_client_stream_rpc_proto_rawDescData
}

var file_client_stream_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_client_stream_rpc_proto_goTypes = []interface{}{
	(*SimpleRequest)(nil),  // 0: proto.SimpleRequest
	(*SimpleResponse)(nil), // 1: proto.SimpleResponse
	(*StreamRequest)(nil),  // 2: proto.StreamRequest
}
var file_client_stream_rpc_proto_depIdxs = []int32{
	0, // 0: proto.StreamClient.Route:input_type -> proto.SimpleRequest
	2, // 1: proto.StreamClient.RouteList:input_type -> proto.StreamRequest
	1, // 2: proto.StreamClient.Route:output_type -> proto.SimpleResponse
	1, // 3: proto.StreamClient.RouteList:output_type -> proto.SimpleResponse
...
func init() { file_client_stream_rpc_proto_init() }
func file_client_stream_rpc_proto_init() {
	if File_client_stream_rpc_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_client_stream_rpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_client_stream_rpc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_client_stream_rpc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_client_stream_rpc_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_client_stream_rpc_proto_goTypes,
		DependencyIndexes: file_client_stream_rpc_proto_depIdxs,
		MessageInfos:      file_client_stream_rpc_proto_msgTypes,
	}.Build()
	File_client_stream_rpc_proto = out.File
	file_client_stream_rpc_proto_rawDesc = nil
	file_client_stream_rpc_proto_goTypes = nil
	file_client_stream_rpc_proto_depIdxs = nil
}
...
var _StreamClient_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "client_stream_rpc.proto",
}
